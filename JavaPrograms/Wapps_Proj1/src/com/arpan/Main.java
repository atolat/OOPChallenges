package com.arpan;// This program prompts the user for the name of a file and then counts the
...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner input = new Scanner(new File("C:\\Users\\arpanpune\\Desktop\\testfile"));
